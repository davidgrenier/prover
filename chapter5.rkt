...
(defun dethm.memb?/remb1 ()
  (J-Bob/define (dethm.memb?/remb0)
                '(((dethm memb?/remb1 (x1)
                   ...
                   ((1 E) (if-false 'nil (if (equal (car (cons x1 (remb '()))) '?)
                                             't
...
(defun dethm.memb?/remb2 ()
  (J-Bob/define (dethm.memb?/remb1)
                '(((dethm memb?/remb2 (x1 x2)
                          (equal (memb? (remb (cons x2
                                                    (cons x1 '())))) 'nil))
                   nil
                   ((1 1) (remb (cons x2
                                      (cons x1 '()))))
                   ((1 1 Q) (atom/cons x2 (cons x1 '())))
                   ((1 1) (if-false '() (if (equal (car (cons x2 (cons x1 '()))) '?)
                   ...
                   ((1) (if-same (equal x2 '?) (memb? (if (equal x2 '?)
                                                          (remb (cons x1 '()))
                   ...
                   ((1 E E Q 1) (car/cons x2 (remb (cons x1 '()))))
                   ((1 E E E 1) (cdr/cons x2 (remb (cons x1 '()))))
                   ((1 E E) (if-nest-E (equal x2 '?)
                                     't
                                     (memb? (remb (cons x1 '())))))
                   ((1 E) (if-false 'nil (memb? (remb (cons x1 '())))))
                   ((1) (if-same (equal x2 '?) (memb? (remb (cons x1 '())))))
                   ((1) (memb?/remb1 x1))
                   (() (equal 'nil 'nil))))))