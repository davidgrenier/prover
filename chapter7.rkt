  ...
  (J-Bob/define (dethm.ctx?/t)
                '(((dethm ctx?/sub (x y)
                   ...
                   ((A E A A A 1 1) (if-nest-E (atom y)
                                               ...
                                               (cons (sub x (car y))
                                                     (sub x (cdr y)))))
                   ((A E A A A 1) (ctx? (cons (sub x (car y))
                                              (sub x (cdr y)))))
                   ((A E A A A 1 Q) (atom/cons (sub x (car y))
                                               (sub x (cdr y))))
                   ((A E A A A 1) (if-false (equal (cons (sub x (car y))
                                            ...
                                            (if (ctx? (car (cons (sub x (car y))
                                                ...
                                                (ctx? (cdr (cons (sub x (car y))
                                                                 (sub x (cdr y))))))))
                   ((A E A A A 1 Q 1) (car/cons (sub x (car y))
                                                (sub x (cdr y))))
                   ((A E A A A 1 E 1) (cdr/cons (sub x (car y))
                                                (sub x (cdr y))))
                   ...
                   ((A E A A A A 1) (if-true 't (ctx? (sub x (cdr y)))))
                   ...
                   ((A E E A) (if-same (ctx? (cdr y))
                                       (if (if (ctx? (cdr y))
                                           ...
                                           (if (ctx? y)
                                               ...
                                               't)
                                           't)))
                   ((A E E A A Q) (if-nest-A (ctx? (cdr y))
                                             (equal (ctx? (sub x (cdr y))) 't)
                                             't))
                   ((A E E A A A A 1 E) (equal-if (ctx? (sub x (cdr y))) 't))
                   ((A E E A A A A 1) (if-same (ctx? (sub x (car y)) 't)))
                   ((A E E A A A A) (equal-same 't))
                   ((A E E A A A) (if-same (ctx? y) 't))
                   ((A E E A A) (if-same (equal (ctx? (sub x (cdr y))) 't) 't))
                   ((A E E A E A Q) (ctx? y))
                   ((A E E A E A Q) (if-nest-E (atom y)
                                               (if (ctx? (car y))
                                                   't
                                                   (ctx? (cdr y)))))
                   ((A E E A E A Q) (if-nest-E (ctx? (car y))
                                               't
                                               (ctx? (cdr y))))
                   ((A E E A E A) (if-nest-E (ctx? (cdr y))
                                             (equal (if (ctx? (sub x (car y)))
                                                        't
                                                        (ctx? (sub x (cdr y)))) 't)
                                             't))
                   ((A E E A E) (if-same (if (ctx? (cdr y))
                                             (equal (ctx? (sub x (cdr y))) 't)
                                             't)
                                         't))
                   ((A E E A) (if-same (ctx? (cdr y)) 't))
                   ((A E E) (if-same (if (ctx? (car y))
                                         (equal (ctx? (sub x (car y))) 't)
                                         't)
                                     't))
